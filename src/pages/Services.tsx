  ...
  const services = [
    {
      ...
      detailedDesc: language === 'fr' ? 'Récompensez l\'excellence de vos équipes avec des voyages incentive au Maroc alliant luxe, aventure et découverte culturelle. Nos programmes sur mesure transforment la motivation en résultats tangibles.' : language === 'es' ? 'Recompense la excelencia de sus equipos con viajes de incentivo en Marruecos que combinan lujo, aventura y descubrimiento cultural. Nuestros programas personalizados transforman la motivación en resultados tangibles.' : language === 'ar' ? 'كافئ تميز فرقك برحلات تحفيزية في المغرب تجمع بين الفخامة والمغامرة والاكتشاف الثقافي. برامجنا المخصصة تحول الدافع إلى نتائج ملموسة.' : 'Reward your teams\' excellence with incentive trips to Morocco combining luxury, adventure and cultural discovery. Our tailor-made programs transform motivation into tangible results.',
    ...
    },
    {
      ...
      detailedDesc: language === 'fr' ? 'Renforcez la cohésion de vos équipes avec nos activités team building innovantes dans des cadres exceptionnels marocains. Du désert aux montagnes de l\'Atlas, créez des liens durables.' : language === 'es' ? 'Refuerce la cohesión de sus equipos con nuestras actividades de team building innovadoras en marcos excepcionales marroquíes. Del desierto a las montañas del Atlas, cree vínculos duraderos.' : language === 'ar' ? 'عزز تماسك فرقك مع أنشطة بناء الفريق المبتكرة في أطر مغربية استثنائية. من الصحراء إلى جبال الأطلس، اخلق روابط دائمة.' : 'Strengthen your teams\' cohesion with our innovative team building activities in exceptional Moroccan settings. From desert to Atlas mountains, create lasting bonds.',
    ...
    },
    {
      ...
      detailedDesc: language === 'fr' ? 'Organisez vos séminaires d\'entreprise dans des lieux inspirants qui stimulent la créativité et favorisent l\'innovation. Riads authentiques, resorts modernes ou camps désertiques selon vos objectifs.' : language === 'es' ? 'Organice sus seminarios corporativos en lugares inspiradores que estimulan la creatividad y favorecen la innovación. Riads auténticos, resorts modernos o campamentos desérticos según sus objetivos.' : language === 'ar' ? 'نظم ندواتك الشركاتية في أماكن ملهمة تحفز الإبداع وتعزز الابتكار. رياضات أصيلة أو منتجعات حديثة أو مخيمات صحراوية حسب أهدافك.' : 'Organize your corporate seminars in inspiring places that stimulate creativity and foster innovation. Authentic riads, modern resorts or desert camps according to your objectives.',
    ...
    },
    {
      ...
      detailedDesc: language === 'fr' ? 'Conférences et conventions dans les centres de congrès les plus modernes du Maroc. Équipements de pointe, services techniques experts et logistique parfaite pour vos événements professionnels.' : language === 'es' ? 'Conferencias y convenciones en los centros de congresos más modernos de Marruecos. Equipos de vanguardia, servicios técnicos expertos y logística perfecta para sus eventos profesionales.' : language === 'ar' ? 'المؤتمرات والمؤتمرات في أحدث مراكز المؤتمرات في المغرب. معدات متطورة وخدمات تقنية خبيرة ولوجستيات مثالية لفعالياتك المهنية.' : 'Conferences and conventions in Morocco\'s most modern congress centers. Cutting-edge equipment, expert technical services and perfect logistics for your professional events.',
