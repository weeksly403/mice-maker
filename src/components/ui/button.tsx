  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-elegant hover:shadow-glow font-semibold transition-bounce",
        cta: "bg-accent text-accent-foreground shadow-elegant hover:bg-accent-hover hover:shadow-glow font-semibold text-base px-8 py-6 rounded-lg transition-bounce",
        gold: "bg-gold text-gold-foreground shadow-glow hover:shadow-elegant font-semibold transition-bounce",
      },
      size: {
