...
export const translations = {
  fr: {
    ...
    // AFCON 2025 - Minimal translations for MVP
    'afcon.meta.title': 'AFCON 2025 Maroc - Hospitalité Corporate & DMC | EventMorocco',
    'afcon.meta.description': 'Services DMC officiels AFCON 2025 au Maroc. Packages VIP, événements parallèles, 6 villes, 52 matchs. Réservez maintenant.',
    'afcon.meta.keywords': 'AFCON 2025 Maroc, hospitalité corporate AFCON, DMC AFCON, packages VIP AFCON',
    'afcon.hero.title': 'AFCON 2025 Maroc : Hospitalité Corporate Exclusive',
    'afcon.hero.subtitle': 'Partenaire DMC Officiel | 6 Villes | 52 Matchs | Opportunités Business Illimitées',
    'afcon.hero.date': '21 Décembre 2025 - 18 Janvier 2026',
    'afcon.hero.cta': 'Voir les Packages',
    'afcon.hero.secondaryCta': 'Télécharger le Guide',
    'afcon.countdown.title': 'Début de l\'AFCON 2025',
    'afcon.countdown.subtitle': 'Ne manquez pas l\'événement sportif d\'Afrique',
    'afcon.countdown.days': 'Jours',
    'afcon.countdown.hours': 'Heures',
    'afcon.countdown.minutes': 'Minutes',
    'afcon.countdown.seconds': 'Secondes',
    'afcon.stats.visitors': 'Visiteurs Attendus',
    'afcon.stats.nations': 'Nations Africaines',
    'afcon.stats.matches': 'Matchs',
    'afcon.stats.economicImpact': 'Impact Économique',
    'afcon.packages.vip.name': 'Package VIP Elite',
    'afcon.packages.premium.name': 'Package Premium Corporate',
    'afcon.packages.essential.name': 'Package Essentiel',
    'afcon.packages.requestInfo': 'Demander des Informations',
    'afcon.form.company': 'Société',
    'afcon.form.name': 'Nom',
    'afcon.form.email': 'Email',
    'afcon.form.consent': 'J\'accepte les conditions',
    'afcon.form.submit': 'Envoyer',
